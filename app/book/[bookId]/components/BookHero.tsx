...
export default function BookHero({
  ...
  if (!nextChapter && !isBookCompleted) return null;
  ...
  return (
    <div className="bg-blue-300 rounded-3xl p-3 pl-4 pr-3 text-gray-800 relative overflow-hidden flex items-center shadow-2xl gap-4 mx-auto max-w-sm border-stone-700">
      ...
      {!isBookCompleted ? (
        ...
        <div className="relative z-10 bg-amber-400 text-white w-12 h-12 rounded-full flex items-center justify-center shrink-0 shadow-[0_0_20px_rgba(251,191,36,0.4)]">
